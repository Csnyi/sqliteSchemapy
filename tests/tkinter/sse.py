...
def sse_listener():
    """Háttérszálban futó SSE eseményfigyelő, amely menti az adatokat SQLite-ba."""
    while True:
        try:
...
# Indítjuk az SSE figyelőt külön szálban
...
# Matplotlib inicializálása két subplot-tal
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 8))
ani = animation.FuncAnimation(fig, update_plot, interval=5000)  # Frissítés 2 másodpercenként

#plt.show()  # Grafikon elindítása
